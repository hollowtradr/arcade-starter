...
export class SwampScene extends Phaser.Scene {
  ...
  preload(): void {
    ...
    this.load.image('yoda_idle',   '/sprites/v3/yoda_idle_v3.png')
    // V2 painted assets (Stage 2 — Gemini-generated, Egor-style)
    this.load.image('yoda_jump',   '/sprites/v3/yoda_jump_v3.png')
    this.load.image('yoda_hit',    '/sprites/v3/yoda_hit_v3.png')
    this.load.image('yoda_defeat', '/sprites/v3/yoda_defeat_v3.png')
    this.load.image('log_v2',      '/sprites/v3/log_v3.png')
    this.load.image('log_sink_v2', '/sprites/v3/log_sinking_v3.png')
    this.load.image('slime_v2',    '/sprites/v3/slime_v3.png')
    this.load.image('vine_v2',     '/sprites/v3/vine_v3.png')
    this.load.image('mynock_v2',   '/sprites/v3/mynock_v3.png')
    this.load.image('bibo_v2',     '/sprites/v3/bibo_v3.png')
    this.load.image('holocron_v2', '/sprites/v3/holocron_v3.png')
    this.load.image('mote_v2',     '/sprites/v3/mote_v3.png')
    this.load.image('tree_far_v2', '/sprites/v3/tree_far_v3.png')
    this.load.image('tree_mid_v2', '/sprites/v3/tree_mid_v3.png')
    this.load.image('tree_near_v2','/sprites/v3/tree_near_v3.png')
    this.load.image('mushroom_v2', '/sprites/v3/mushroom_v3.png')
    this.load.image('reed_v2',     '/sprites/v2/reed_v2.png')
    this.load.image('ground_v2',   '/sprites/v3/ground_v3.png')
  }
